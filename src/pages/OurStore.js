      ...
      <Container class1="store-wrapper home-wrapper-2 py-5">
        <div className="row">
          <div className="col-3">
            ...
            <div className="filter-card mb-3">
              <h3 className="filter-title">Fliter By </h3>
              <div>
            ...
            <div className="filter-card mb-3">
              ...
              <div>
                <div className="random-products mb-3 d-flex">
                  <div className="w-50">
                    <img src={famous2} className="img-fluid" alt="laptop" />
                  </div>
                  <div className="w-50">
                    <h5>
                      Kids Laptops bulk 10 pack multi colored for students
                    </h5>
                    <ReactStars
                      count={5}
                      size={24}
                ...
                <div className="random-products d-flex">
                  <div className="w-50">
                    <img src={famous4} className="img-fluid" alt="Speaker" />
                  </div>
                  <div className="w-50">
                    <h5>
                      Kids Speaker bulk 10 pack multi colored for students
                    </h5>
                    <ReactStars
                      count={5}
                      size={24}
